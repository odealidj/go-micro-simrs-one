...
const buildNavGroups = (poliLabel: string): NavGroup[] => [
  {
    title: null,
    items: [
      { name: "Dashboard", path: "/perawat", exact: true, icon: LayoutDashboard },
    ],
  },
  {
    title: poliLabel,
    items: [
      { name: "Antrean Pasien", path: "/perawat/antrean", icon: ListChecks },
      { name: "Input Triage", path: "/perawat/triage", icon: ClipboardEdit },
    ],
  },
];
