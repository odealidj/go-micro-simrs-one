...
const buildNavGroups = (poliLabel: string): NavGroup[] => [
  {
    title: null,
    items: [
      { name: "Dashboard", path: "/dokter", exact: true, icon: LayoutDashboard },
    ],
  },
  {
    title: poliLabel,
    items: [
      { name: "Antrean Pasien", path: "/dokter/antrean", icon: ListChecks },
    ],
  },
  {
    title: "Rekam Medis",
    items: [
      { name: "Riwayat Kunjungan", path: "/dokter/riwayat", icon: ClipboardPlus },
    ],
  },
];
